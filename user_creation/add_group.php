...
<section class="content-header">
        ...
        <!--End of main menu-->
        <div>
        <form class="form-horizontal" name="contact_form" id="contact_form" method="post" action="add_group_validation.php">
            <input type="hidden" name="mode" value="login" >

            <fieldset>
                <div class="form-group">
                    <label class="col-lg-2 control-label" for="role_rolecode"><span class="required">*</span>Group Name:</label>
                    <div class="col-lg-6">
                        <input type="text" value="" placeholder="Group Name" id="role_rolecode" class="form-control" name="role_rolecode" required="" >
                    </div>
                </div>
