            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  echo $row['u_username'];
                  ?>
                  <span class="hidden-xs"><?php $row['u_username']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="Inventory/addCategory.php"><i class="fa fa-circle-o"></i> Add Category</a></li>
                 <?php if (authorize($_SESSION["access"]["INVT"]["Add_Category"]["create"]) ){ ?>
                <li><a href="Inventory/addCategory.php"><i class="fa fa-circle-o"></i> Add Item</a></li>
                <?php } ?>
              ...
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>User Creation</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href=""><i class="fa fa-circle-o"></i> Add Branch</a></li>
                <li class="active"><a href=""><i class="fa fa-circle-o"></i> Add Group</a></li>
                <li class="active"><a href=""><i class="fa fa-circle-o"></i> Add Roles</a></li>
                <li class="active"><a href=""><i class="fa fa-circle-o"></i> Add User</a></li>
